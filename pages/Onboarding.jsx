...
export default function Onboarding() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Creators still need a public profile, so send them straight into the application.
      navigate(role === 'creator' ? '/apply' : '/client-dashboard', { replace: true });
    } catch (err) {
    ...
    <div className="min-h-screen bg-ink">
      <div className="max-w-3xl mx-auto px-5 md:px-10 pt-32 pb-24">
        ...
        <p className="font-body text-[14px] leading-relaxed text-white/45 max-w-lg mb-12">
          Clients and creators see different portals. Pick the one you need now — you can switch later in your dashboard.
        </p>
