    ...
    <div className="min-h-screen" style={{ background: '#f0ede6' }}>
      ...
      <section className="max-w-[1180px] mx-auto px-8 md:px-14 pb-24 relative z-10">
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
          ...
          <div className="flex items-center gap-1 border p-1 shrink-0" style={{ background: '#ece9e2', borderColor: 'rgba(26,39,68,0.12)' }}>
        ...
        {viewMode === 'constellation' ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">{Array(6).fill(0).map((_, i) => <Skeleton key={i} className="h-[520px]" />)}</div>
        ) : filtered.length > 0 ? (
