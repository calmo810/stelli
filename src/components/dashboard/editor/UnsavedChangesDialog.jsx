  ...
  return (
    <Dialog open={open} onOpenChange={(next) => { if (!next) onKeepEditing(); }}>
      <DialogContent className="max-w-md" style={{ background: 'hsl(var(--surface))', borderColor: 'rgba(255,255,255,0.12)' }}>
        <DialogHeader>
          <DialogTitle className="font-heading text-2xl text-white">You have unsaved changes. Leave anyway?</DialogTitle>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-3">
          ...
          <button
            ...
            style={{ background: 'hsl(var(--neon-cyan))', color: '#0a0f1e', borderRadius: 4 }}
          >
            Leave
          </button>
        </div>
